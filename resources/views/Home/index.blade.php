                        ...
                        @foreach ($blogs as $blog)
                            <div class="col-md-7 col-sm-12 col-lg-7">
                                <div class="post-bx lst brd-rd5">
                                    <div class="post-thmb"><a href="{{ route('blog.detail', $blog->id) }}" title=""
                                            itemprop="url"><img src="{{ $blog->image }}" alt="{{ $blog->title }}"
                                                itemprop="image"></a>
                                    </div>
                                    <div class="post-inf">
                                        <h5 itemprop="headline"><a href="{{ route('blog.detail', $blog->id) }}"
                                                title="" itemprop="url">{{ $blog->title }}</a></h5>
                                        <ul class="pst-mta">
