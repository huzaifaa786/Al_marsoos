...
@section('content')
    ...
    <div class="card mx-5 p-3 rounded-4">
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data" action="{{route('event.update')}}">
                @csrf
                <input type="text" name="id" id="" value="{{ $event->id }}" hidden>
                <div class="row mt-3">
                    <div class="col">
                ...
                <div class="mt-3">
                    ...
                    <textarea class="form-control" id="description" rows="3"  name="description" placeholder="Add description of the course">{{ $event->description }}</textarea>
                </div>
