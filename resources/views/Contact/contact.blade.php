...
@section('content')
    <section>
        <div class="gap black-layer opc75">
            <div class="fixed-bg2" style="background-image: url({{ asset('asset/images/islamicb1.jpg') }});"></div>
            <div class="container">
        ...
        <div class="gap">
            <div class="container">
                ...
                <div class="cnt-frm text-center">
                    <form method="post" action="{{ route('Contact.contact') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mrg10">
                ...
                <div class="cnt-inf-wrp">
                    <div class="row">
                        ...
                        <div class="col-md-5 col-sm-12 col-lg-5">
                            <div class="cnt-img brd-rd5"><img src="{{ asset('asset/images/resources/photo2.jpg') }}" alt="Contact.jpg"
