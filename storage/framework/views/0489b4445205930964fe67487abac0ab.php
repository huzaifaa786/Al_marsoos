        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-10 offset-md-1 col-12 pt-2">
                <div class="border rounded mt-5 p-4">
                    ...
                    <p class="lead">Fill and submit this form to update the post</p>
                    ...
                    <form action="<?php echo e(route('blog.update')); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id="body" id="summernote" class="summernote" class="form-control" name="body" 
                                placeholder="Enter Post Body" rows="5" ><?php echo e($blog->body); ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\LARAVEL\Al_marsoos\resources\views/admin/blog/update.blade.php ENDPATH**/ ?>