...
<div class="card">
    <div class="card-body">
      ...
      <!-- Vertical Form -->
      <form class="row g-3"  method="POST"   enctype="multipart/form-data" action="<?php echo e(route('addstudents')); ?>">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\php\Al_marsoos\resources\views/admin/students/newstudents.blade.php ENDPATH**/ ?>