...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card mx-5 p-3 rounded-4">
        <div class="card-body">
            ...
            <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('scholar.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="row mt-3">
                    <div class="col">
...
<?php echo $__env->make('Admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\laraval\Al_marsoos\resources\views/admin/scholars/create.blade.php ENDPATH**/ ?>